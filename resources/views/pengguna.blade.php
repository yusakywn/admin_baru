...
<div class="content-wrapper bg-white">
   ...
   <div class="content-header">
      <div class="container-fluid">
         <div class="row">
            <div class="col-md-12">
               <div class="row mr-3 mt-3 mb-3 text-right">
                <button type="button" class="mx-2 btn btn-success" data-toggle="modal" data-target="#exampleModal">Broadcast</button>
                <div class="w-25 mx-2">
                    <select class="form-control">
                      <option value="1">All Users</option>
                      <option value="2">All Freelancers</option>
                      <option value="3">All Videographers</option>
                      <option value="4">All Photographers</option>
                    </select>
                </div>
               </div>
               <div class="card">
